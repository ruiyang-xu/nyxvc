...
import AlvinXiao from "@/assets/AlvinXiao.webp";
...
import NathanYu from "@/assets/NathanYu.webp";
        ...
        <div className="card w-96 h-[480px] shadow-x  bg-base-300 text-base "
            ...
            onMouseLeave={handleMouseLeave}>
            {
                showDescription ? (
                    <div className="m-10">
                        {/* 为figure添加点击事件处理函数 */}
                        <figure ><img src={props.userImag} alt={props.userName} /></figure>
                        <div className="card-body flex justify-center items-center">
                            <h2 className="card-title">{props.userName}</h2>
                            <p className="">General Partner</p>
                    ...
                    <p className={`duration-300 m-10`} >{props.description}</p>
                )
            }
        </div >
    )
    ...
    return (
        <div className='pb-10' id="TEAM">
            ...
            <div className="flex flex-wrap-reverse justify-center gap-40 pt-10" >
                ...
                <User userImag={AlvinXiao} userName="Alvin Xiao" description={` Alvin is currently undertaking a variety of roles: advisor to the CEO of Seer.AI  + other companies he invested in through his family office. Past investments include allocations to Rippling and Jasper AI; he is also a co-founder of an ocean robotics company working on ocean floor sampling. Additionally, he is also a full-time student at UC Berkeley under engineering and business.`} images={[AlvinXiaoBg1, AlvinXiaoBg2, AlvinXiaoBg3, AlvinXiaoBg5]} />
